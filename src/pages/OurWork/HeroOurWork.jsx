    ...
    <div className="relative w-full box-border">
      ...
      <div className="flex flex-col lg:relative">
        <div className="relative h-[50vh] w-full lg:h-[70vh]">
          ...
          <img
            src="/mansion.webp"
            className={`absolute inset-0 object-cover object-center lg:transition-all lg:duration-500 lg:ease-linear w-full h-full`}
          ></img>
          {/* Layer  */}
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-5 text-white gap-5 lg:w-1/2 lg:px-20 lg:gap-10">
            <div className="flex gap-3 items-center text-xs">
              ...
              <span className="text-neutral-300 uppercase">{`Our Work`}</span>
            </div>
            ...
            <div className="flex justify-center items-center bg-white uppercase text-black p-3 shadow-md text-sm lg:mr-auto">
